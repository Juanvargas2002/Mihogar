                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="user" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" name="usuario" id="usuario" required>
                            </div>
...
<footer class="bg-primary text-white text-center py-3 mt-auto width-100vh">
    <p class="mb-0">© 2025 Servicios Técnicos Mi Hogar. Todos los derechos reservados.</p>
</footer>
