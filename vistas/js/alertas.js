    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            .then(respuesta =>{
                ...
                // Si guardamos un monitoreo correctamente, recargar la página para poner uno nuevo
                if (action && action.indexOf('monitoreoAjax.php') !== -1 && tipo === 'save' && respuesta && respuesta.Tipo === 'success') {
